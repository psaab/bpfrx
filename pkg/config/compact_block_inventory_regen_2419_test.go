...
# last two are a defect of the same shape as #8933 — the elided
# "tunnel routing-instance destination vrf1" compiles RoutingInstance to
# "destination" rather than to "vrf1", binding the tunnel to a routing-instance
# that does not exist.
#
