...
// PORTED FROM PR #8953 (lane-8388) after a double-assignment I made sent two
// lanes at the syslog rows. #8957 landed the admission and the #8852 census
// fix; these two cells are coverage it did not carry, kept rather than
// discarded because the work was correct and the collision was mine.
