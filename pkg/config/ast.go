...
var setSchema = &schemaNode{children: map[string]*schemaNode{
	...
	"interfaces": {desc: "Interface configuration", wildcard: &schemaNode{valueHint: ValueHintInterfaceName, placeholder: "<interface-name>", children: map[string]*schemaNode{
		...
		"tunnel": {desc: "Tunnel parameters", children: map[string]*schemaNode{
			...
			"wg-public-key":    {desc: "WireGuard public key", args: 1, children: nil},
			"wg-listen-port":   {desc: "WireGuard listen port", args: 1, children: nil},
		...
		"wireguard": {desc: "WireGuard configuration", children: map[string]*schemaNode{
			"private-key": {desc: "WireGuard private key", args: 1, children: nil},
			"public-key":  {desc: "WireGuard public key", args: 1, children: nil},
			"listen-port": {desc: "WireGuard listen port", args: 1, children: nil},
			"peer": {desc: "WireGuard peer", children: map[string]*schemaNode{
				"public-key":           {desc: "Peer public key", args: 1, children: nil},
				"endpoint":             {desc: "Peer endpoint address", args: 1, children: nil},
				"allowed-ips":          {desc: "Peer allowed IPs", args: 1, children: nil},
				"persistent-keepalive": {desc: "Persistent keepalive interval", args: 1, children: nil},
			}},
		}},
