...
type bpfrxTcNatAppRangeEntry struct {
	_           structs.HostLayout
	Protocol    uint8
	AlgType     uint8
	PortLow     uint16
...
type bpfrxTcNatFabricFwdInfo struct {
	_          structs.HostLayout
	Ifindex    uint32
	FibIfindex uint32
	PeerMac    [6]uint8
...
type bpfrxTcNatMirrorConfig struct {
	_             structs.HostLayout
...
type bpfrxTcNatNat64FibCacheKey struct {
	_       structs.HostLayout
	Ipv4Dst uint32
	Tbid    uint32
}

type bpfrxTcNatNat64FibCacheVal struct {
	_       structs.HostLayout
	Ifindex uint32
	VlanId  uint16
	Gen     uint16
...
type bpfrxTcNatNptv6Key struct {
	_         structs.HostLayout
	Prefix    [8]uint8
	Direction uint8
	PrefixLen uint8
...
type bpfrxTcNatNptv6Value struct {
	_           structs.HostLayout
	XlatPrefix  [8]uint8
	Adjustment  uint16
	PrefixWords uint8
...
type bpfrxTcNatPolicerConfig struct {
	_            structs.HostLayout
	RateBytesSec uint64
	BurstBytes   uint64
	Action       uint8
...
type bpfrxTcNatPolicerState struct {
	_            structs.HostLayout
	Tokens       uint64
	LastRefillNs uint64
	PeakTokens   uint64
...
type bpfrxTcNatRstSuppressV6Key struct {
	_    structs.HostLayout
	Addr [16]uint8
}
...
type bpfrxTcNatSessionCountKey struct {
	_      structs.HostLayout
	Ip     uint32
	ZoneId uint16
	Pad    uint16
...
type bpfrxTcNatSessionCountValue struct {
	_     structs.HostLayout
	Count uint32
}
...
type bpfrxTcNatSnatEgressKey struct {
	_       structs.HostLayout
	Ifindex uint32
	VlanId  uint16
	Pad     uint16
...
type bpfrxTcNatSnatEgressValue struct {
	_    structs.HostLayout
	Ipv4 uint32
	Ipv6 [16]uint8
}
...
type bpfrxTcNatValidatedClientKey struct {
	_       structs.HostLayout
	SrcIp   uint32
	DstIp   uint32
	DstPort uint16
...
type bpfrxTcNatValidatedClientValue struct {
	_           structs.HostLayout
	ValidatedAt uint64
}
