...
type bpfrxXdpForwardAppRangeEntry struct {
	_           structs.HostLayout
	Protocol    uint8
	AlgType     uint8
	PortLow     uint16
...
type bpfrxXdpForwardMirrorConfig struct {
	_             structs.HostLayout
...
type bpfrxXdpForwardNat64FibCacheKey struct {
	_       structs.HostLayout
	Ipv4Dst uint32
	Tbid    uint32
}

type bpfrxXdpForwardNat64FibCacheVal struct {
	_       structs.HostLayout
	Ifindex uint32
	VlanId  uint16
	Gen     uint16
...
type bpfrxXdpForwardNptv6Key struct {
	_         structs.HostLayout
	Prefix    [8]uint8
	Direction uint8
	PrefixLen uint8
...
type bpfrxXdpForwardNptv6Value struct {
	_           structs.HostLayout
	XlatPrefix  [8]uint8
	Adjustment  uint16
	PrefixWords uint8
...
type bpfrxXdpForwardPolicerConfig struct {
	_            structs.HostLayout
	RateBytesSec uint64
	BurstBytes   uint64
	Action       uint8
...
type bpfrxXdpForwardPolicerState struct {
	_            structs.HostLayout
	Tokens       uint64
	LastRefillNs uint64
	PeakTokens   uint64
...
type bpfrxXdpForwardRstSuppressV6Key struct {
	_    structs.HostLayout
	Addr [16]uint8
}
...
type bpfrxXdpForwardSessionCountKey struct {
	_      structs.HostLayout
	Ip     uint32
	ZoneId uint16
	Pad    uint16
...
type bpfrxXdpForwardSessionCountValue struct {
	_     structs.HostLayout
	Count uint32
}
...
type bpfrxXdpForwardSnatEgressKey struct {
	_       structs.HostLayout
	Ifindex uint32
	VlanId  uint16
	Pad     uint16
...
type bpfrxXdpForwardSnatEgressValue struct {
	_    structs.HostLayout
	Ipv4 uint32
	Ipv6 [16]uint8
}
...
type bpfrxXdpForwardValidatedClientKey struct {
	_       structs.HostLayout
	SrcIp   uint32
	DstIp   uint32
	DstPort uint16
...
type bpfrxXdpForwardValidatedClientValue struct {
	_           structs.HostLayout
	ValidatedAt uint64
}
