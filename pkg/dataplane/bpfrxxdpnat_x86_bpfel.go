...
type bpfrxXdpNatAppRangeEntry struct {
	_           structs.HostLayout
	Protocol    uint8
	AlgType     uint8
	PortLow     uint16
...
type bpfrxXdpNatFabricFwdInfo struct {
	_          structs.HostLayout
	Ifindex    uint32
	FibIfindex uint32
	PeerMac    [6]uint8
...
type bpfrxXdpNatMirrorConfig struct {
	_             structs.HostLayout
...
type bpfrxXdpNatNat64FibCacheKey struct {
	_       structs.HostLayout
	Ipv4Dst uint32
	Tbid    uint32
}

type bpfrxXdpNatNat64FibCacheVal struct {
	_       structs.HostLayout
	Ifindex uint32
	VlanId  uint16
	Gen     uint16
...
type bpfrxXdpNatNptv6Key struct {
	_         structs.HostLayout
	Prefix    [8]uint8
	Direction uint8
	PrefixLen uint8
...
type bpfrxXdpNatNptv6Value struct {
	_           structs.HostLayout
	XlatPrefix  [8]uint8
	Adjustment  uint16
	PrefixWords uint8
...
type bpfrxXdpNatPolicerConfig struct {
	_            structs.HostLayout
	RateBytesSec uint64
	BurstBytes   uint64
	Action       uint8
...
type bpfrxXdpNatPolicerState struct {
	_            structs.HostLayout
	Tokens       uint64
	LastRefillNs uint64
	PeakTokens   uint64
...
type bpfrxXdpNatRstSuppressV6Key struct {
	_    structs.HostLayout
	Addr [16]uint8
}
...
type bpfrxXdpNatSessionCountKey struct {
	_      structs.HostLayout
	Ip     uint32
	ZoneId uint16
	Pad    uint16
...
type bpfrxXdpNatSessionCountValue struct {
	_     structs.HostLayout
	Count uint32
}
...
type bpfrxXdpNatSnatEgressKey struct {
	_       structs.HostLayout
	Ifindex uint32
	VlanId  uint16
	Pad     uint16
...
type bpfrxXdpNatSnatEgressValue struct {
	_    structs.HostLayout
	Ipv4 uint32
	Ipv6 [16]uint8
}
...
type bpfrxXdpNatValidatedClientKey struct {
	_       structs.HostLayout
	SrcIp   uint32
	DstIp   uint32
	DstPort uint16
...
type bpfrxXdpNatValidatedClientValue struct {
	_           structs.HostLayout
	ValidatedAt uint64
}
