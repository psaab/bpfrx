		...
		Bindings: []userspace.BindingStatus{
			{
				...
				Nat64Translations: 12, Nat64NoSourcePool: 3, Nat64PoolExhausted: 5, Nat64FragDropped: 2, Nat64IneligibleSource: 4, Nat64IneligibleDest: 6, Nat64ExthdrIneligible: 7,
