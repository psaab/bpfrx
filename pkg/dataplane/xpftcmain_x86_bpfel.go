...
type xpfTcMainAddrMembershipKey struct {
	_         structs.HostLayout
	Ip        uint32
	AddressId uint32
}

type xpfTcMainAddrValue struct {
	_         structs.HostLayout
	AddressId uint32
}

type xpfTcMainAppKey struct {
	_        structs.HostLayout
	Protocol uint8
	Pad      uint8
	DstPort  uint16
...
type xpfTcMainAppRangeEntry struct {
	_           structs.HostLayout
	Protocol    uint8
	AlgType     uint8
	PortLow     uint16
...
type xpfTcMainBpfDevmapVal struct {
	_       structs.HostLayout
	Ifindex uint32
	BpfProg struct {
		_  structs.HostLayout
...
type xpfTcMainCounterValue struct {
	_       structs.HostLayout
	Packets uint64
	Bytes   uint64
}

type xpfTcMainCpumapVal struct {
	_         structs.HostLayout
	Qsize     uint32
	BpfProgFd uint32
}

type xpfTcMainDnatKey struct {
	_        structs.HostLayout
	Protocol uint8
	Pad      [3]uint8
	DstIp    uint32
...
type xpfTcMainDnatKeyV6 struct {
	_        structs.HostLayout
	Protocol uint8
	Pad      [3]uint8
	DstIp    [16]uint8
...
type xpfTcMainDnatValue struct {
	_          structs.HostLayout
	NewDstIp   uint32
	NewDstPort uint16
	Flags      uint8
...
type xpfTcMainDnatValueV6 struct {
	_          structs.HostLayout
	NewDstIp   [16]uint8
	NewDstPort uint16
	Flags      uint8
...
type xpfTcMainFabricFwdInfo struct {
	_          structs.HostLayout
	Ifindex    uint32
	FibIfindex uint32
	PeerMac    [6]uint8
...
type xpfTcMainFilterConfig struct {
	_            structs.HostLayout
	NumRules     uint32
	RuleStart    uint32
	AllHaveProto uint8
...
type xpfTcMainFilterRule struct {
	_            structs.HostLayout
	MatchFlags   uint16
	Dscp         uint8
	Protocol     uint8
...
type xpfTcMainFloodState struct {
	_              structs.HostLayout
	SynCount       uint64
	IcmpCount      uint64
	UdpCount       uint64
...
type xpfTcMainFlowConfig struct {
	_                 structs.HostLayout
	TcpMssIpsec       uint16
	TcpMssGreIn       uint16
	TcpMssGreOut      uint16
...
type xpfTcMainIfaceCounterValue struct {
	_         structs.HostLayout
	RxPackets uint64
	RxBytes   uint64
	TxPackets uint64
...
type xpfTcMainIfaceFilterKey struct {
	_         structs.HostLayout
	Ifindex   uint32
	VlanId    uint16
	Family    uint8
...
type xpfTcMainIfaceZoneKey struct {
	_       structs.HostLayout
	Ifindex uint32
	VlanId  uint16
	Pad     uint16
...
type xpfTcMainIfaceZoneValue struct {
	_            structs.HostLayout
	ZoneId       uint16
	Flags        uint8
	RgId         uint8
...
type xpfTcMainLpmKeyV4 struct {
	_         structs.HostLayout
	Prefixlen uint32
	Addr      uint32
}

type xpfTcMainLpmKeyV6 struct {
	_         structs.HostLayout
	Prefixlen uint32
	Addr      [16]uint8
}

type xpfTcMainMirrorConfig struct {
	_             structs.HostLayout
	MirrorIfindex uint32
	Rate          uint32
}

type xpfTcMainNat64Config struct {
	_          structs.HostLayout
	Prefix     [3]uint32
	SnatPoolId uint8
	Pad        [3]uint8
...
type xpfTcMainNat64FibCacheKey struct {
	_       structs.HostLayout
	Ipv4Dst uint32
	Tbid    uint32
}

type xpfTcMainNat64FibCacheVal struct {
	_       structs.HostLayout
	Ifindex uint32
	VlanId  uint16
	Gen     uint16
...
type xpfTcMainNat64PrefixKey struct {
	_      structs.HostLayout
	Prefix [3]uint32
}

type xpfTcMainNat64StateKey struct {
	_        structs.HostLayout
	SrcIp    uint32
	DstIp    uint32
	SrcPort  uint16
...
type xpfTcMainNat64StateValue struct {
	_           structs.HostLayout
	OrigSrcV6   [16]uint8
	OrigDstV6   [16]uint8
	OrigSrcPort uint16
...
type xpfTcMainNptv6Value struct {
	_           structs.HostLayout
	XlatPrefix  [8]uint8
	Adjustment  uint16
	PrefixWords uint8
...
type xpfTcMainPolicerConfig struct {
	_            structs.HostLayout
	RateBytesSec uint64
	BurstBytes   uint64
	Action       uint8
...
type xpfTcMainPolicerState struct {
	_            structs.HostLayout
	Tokens       uint64
	LastRefillNs uint64
	PeakTokens   uint64
...
type xpfTcMainPolicyRule struct {
	_           structs.HostLayout
	RuleId      uint32
	PolicySetId uint32
	Sequence    uint16
...
type xpfTcMainPolicySet struct {
	_             structs.HostLayout
	PolicySetId   uint32
	NumRules      uint16
...
type xpfTcMainScanTrackKey struct {
	_      structs.HostLayout
	SrcIp  uint32
	ZoneId uint16
	Pad    uint16
...
type xpfTcMainScanTrackValue struct {
	_           structs.HostLayout
	Count       uint32
	WindowStart uint32
}

type xpfTcMainScreenConfig struct {
	_                 structs.HostLayout
	Flags             uint32
...
type xpfTcMainSessionCountKey struct {
	_      structs.HostLayout
	Ip     uint32
	ZoneId uint16
	Pad    uint16
...
type xpfTcMainSessionCountValue struct {
	_     structs.HostLayout
	Count uint32
}

type xpfTcMainSessionKey struct {
	_        structs.HostLayout
	SrcIp    uint32
	DstIp    uint32
	SrcPort  uint16
...
type xpfTcMainSessionKeyV6 struct {
	_        structs.HostLayout
	SrcIp    [16]uint8
	DstIp    [16]uint8
	SrcPort  uint16
...
type xpfTcMainSessionValue struct {
	_           structs.HostLayout
	State       uint8
	Flags       uint8
	TcpState    uint8
	...
	RevPackets  uint64
	RevBytes    uint64
	ReverseKey  xpfTcMainSessionKey
	AlgType     uint8
	LogFlags    uint8
	AppId       uint16
	FibIfindex  uint32
...
type xpfTcMainSessionValueV6 struct {
	_           structs.HostLayout
	State       uint8
	Flags       uint8
	TcpState    uint8
	...
	RevPackets  uint64
	RevBytes    uint64
	ReverseKey  xpfTcMainSessionKeyV6
	AlgType     uint8
	LogFlags    uint8
	AppId       uint16
	FibIfindex  uint32
...
type xpfTcMainSnatEgressKey struct {
	_       structs.HostLayout
	Ifindex uint32
	VlanId  uint16
	Pad     uint16
...
type xpfTcMainSnatEgressValue struct {
	_    structs.HostLayout
	Ipv4 uint32
	Ipv6 [16]uint8
}

type xpfTcMainSnatValue struct {
	_         structs.HostLayout
	SnatIp    uint32
	SrcAddrId uint32
	DstAddrId uint32
...
type xpfTcMainSnatValueV6 struct {
	_         structs.HostLayout
	SnatIp    [16]uint8
	SrcAddrId uint32
	DstAddrId uint32
...
type xpfTcMainStaticNatKeyV4 struct {
	_         structs.HostLayout
	Ip        uint32
	Direction uint8
	Pad       [3]uint8
...
type xpfTcMainStaticNatKeyV6 struct {
	_         structs.HostLayout
	Ip        [16]uint8
	Direction uint8
	Pad       [3]uint8
...
type xpfTcMainStaticNatValueV6 struct {
	_  structs.HostLayout
	Ip [16]uint8
}

type xpfTcMainValidatedClientKey struct {
	_       structs.HostLayout
	SrcIp   [16]uint8
	DstIp   [16]uint8
	DstPort uint16
...
type xpfTcMainValidatedClientValue struct {
	_           structs.HostLayout
	ValidatedAt uint64
}

type xpfTcMainVlanIfaceInfo struct {
	_             structs.HostLayout
...
type xpfTcMainZoneConfig struct {
	_                structs.HostLayout
	ZoneId           uint16
...
// loadXpfTcMain returns the embedded CollectionSpec for xpfTcMain.
func loadXpfTcMain() (*ebpf.CollectionSpec, error) {
	reader := bytes.NewReader(_XpfTcMainBytes)
	spec, err := ebpf.LoadCollectionSpecFromReader(reader)
	if err != nil {
		return nil, fmt.Errorf("can't load xpfTcMain: %w", err)
	}

	return spec, err
}

// loadXpfTcMainObjects loads xpfTcMain and converts it into a struct.
//
...
func loadXpfTcMainObjects(obj interface{}, opts *ebpf.CollectionOptions) error {
	spec, err := loadXpfTcMain()
	if err != nil {
		return err
	}
...
// xpfTcMainSpecs contains maps and programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type xpfTcMainSpecs struct {
	xpfTcMainProgramSpecs
	xpfTcMainMapSpecs
	xpfTcMainVariableSpecs
}

// xpfTcMainProgramSpecs contains programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type xpfTcMainProgramSpecs struct {
	TcMainProg *ebpf.ProgramSpec `ebpf:"tc_main_prog"`
}

// xpfTcMainMapSpecs contains maps before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type xpfTcMainMapSpecs struct {
...
// xpfTcMainVariableSpecs contains global variables before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type xpfTcMainVariableSpecs struct {
}

// xpfTcMainObjects contains all objects after they have been loaded into the kernel.
//
// It can be passed to loadXpfTcMainObjects or ebpf.CollectionSpec.LoadAndAssign.
type xpfTcMainObjects struct {
	xpfTcMainPrograms
	xpfTcMainMaps
	xpfTcMainVariables
}

func (o *xpfTcMainObjects) Close() error {
	return _XpfTcMainClose(
		&o.xpfTcMainPrograms,
		&o.xpfTcMainMaps,
	)
}

// xpfTcMainMaps contains all maps after they have been loaded into the kernel.
//
// It can be passed to loadXpfTcMainObjects or ebpf.CollectionSpec.LoadAndAssign.
type xpfTcMainMaps struct {
...
func (m *xpfTcMainMaps) Close() error {
	return _XpfTcMainClose(
		m.AddressBookV4,
		m.AddressBookV6,
		m.AddressMembership,
...
// xpfTcMainVariables contains all global variables after they have been loaded into the kernel.
//
// It can be passed to loadXpfTcMainObjects or ebpf.CollectionSpec.LoadAndAssign.
type xpfTcMainVariables struct {
}

// xpfTcMainPrograms contains all programs after they have been loaded into the kernel.
//
// It can be passed to loadXpfTcMainObjects or ebpf.CollectionSpec.LoadAndAssign.
type xpfTcMainPrograms struct {
	TcMainProg *ebpf.Program `ebpf:"tc_main_prog"`
}

func (p *xpfTcMainPrograms) Close() error {
	return _XpfTcMainClose(
		p.TcMainProg,
	)
}

func _XpfTcMainClose(closers ...io.Closer) error {
...
//
//go:embed xpftcmain_x86_bpfel.o
var _XpfTcMainBytes []byte
