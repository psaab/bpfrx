...
type Manager struct {
	...
	// empty: the flood POPULATE path is still deferred (docs/research/
	// 3643-dead-counters/plan.md §5A, leaning on the #3343 aggregate), so those
	// reads report ErrCounterNotPopulated unconditionally. Surfaces render
