...
type xpfXdpConntrackAddrMembershipKey struct {
	_         structs.HostLayout
	Ip        uint32
	AddressId uint32
}

type xpfXdpConntrackAddrValue struct {
	_         structs.HostLayout
	AddressId uint32
}

type xpfXdpConntrackAppKey struct {
	_        structs.HostLayout
	Protocol uint8
	Pad      uint8
	DstPort  uint16
...
type xpfXdpConntrackAppRangeEntry struct {
	_           structs.HostLayout
	Protocol    uint8
	AlgType     uint8
	PortLow     uint16
...
type xpfXdpConntrackAppValue struct {
	_           structs.HostLayout
	AppId       uint32
	AlgType     uint8
	Pad         uint8
...
type xpfXdpConntrackBpfDevmapVal struct {
	_       structs.HostLayout
	Ifindex uint32
	BpfProg struct {
		_  structs.HostLayout
...
type xpfXdpConntrackCounterValue struct {
	_       structs.HostLayout
	Packets uint64
	Bytes   uint64
}

type xpfXdpConntrackCpumapVal struct {
	_         structs.HostLayout
	Qsize     uint32
	BpfProgFd uint32
}

type xpfXdpConntrackDnatKey struct {
	_        structs.HostLayout
	Protocol uint8
	Pad      [3]uint8
	DstIp    uint32
...
type xpfXdpConntrackDnatValueV6 struct {
	_          structs.HostLayout
	NewDstIp   [16]uint8
	NewDstPort uint16
	Flags      uint8
...
type xpfXdpConntrackFabricFwdInfo struct {
	_          structs.HostLayout
	Ifindex    uint32
	FibIfindex uint32
	PeerMac    [6]uint8
...
type xpfXdpConntrackFilterConfig struct {
	_            structs.HostLayout
	NumRules     uint32
	RuleStart    uint32
	AllHaveProto uint8
...
type xpfXdpConntrackFilterRule struct {
	_            structs.HostLayout
	MatchFlags   uint16
	Dscp         uint8
	Protocol     uint8
...
type xpfXdpConntrackFloodState struct {
	_              structs.HostLayout
	SynCount       uint64
	IcmpCount      uint64
	UdpCount       uint64
...
type xpfXdpConntrackFlowConfig struct {
	_                 structs.HostLayout
	TcpMssIpsec       uint16
	TcpMssGreIn       uint16
	TcpMssGreOut      uint16
...
type xpfXdpConntrackIfaceCounterValue struct {
	_         structs.HostLayout
	RxPackets uint64
	RxBytes   uint64
	TxPackets uint64
...
type xpfXdpConntrackIfaceFilterKey struct {
	_         structs.HostLayout
	Ifindex   uint32
	VlanId    uint16
	Family    uint8
...
type xpfXdpConntrackIfaceZoneKey struct {
	_       structs.HostLayout
	Ifindex uint32
	VlanId  uint16
	Pad     uint16
...
type xpfXdpConntrackIfaceZoneValue struct {
	_            structs.HostLayout
	ZoneId       uint16
	Flags        uint8
	RgId         uint8
...
type xpfXdpConntrackLpmKeyV4 struct {
	_         structs.HostLayout
	Prefixlen uint32
	Addr      uint32
}

type xpfXdpConntrackLpmKeyV6 struct {
	_         structs.HostLayout
	Prefixlen uint32
	Addr      [16]uint8
}

type xpfXdpConntrackMirrorConfig struct {
	_             structs.HostLayout
	MirrorIfindex uint32
	Rate          uint32
}

type xpfXdpConntrackNat64Config struct {
	_          structs.HostLayout
	Prefix     [3]uint32
	SnatPoolId uint8
	Pad        [3]uint8
...
type xpfXdpConntrackNat64FibCacheKey struct {
	_       structs.HostLayout
	Ipv4Dst uint32
	Tbid    uint32
}

type xpfXdpConntrackNat64FibCacheVal struct {
	_       structs.HostLayout
	Ifindex uint32
	VlanId  uint16
	Gen     uint16
...
type xpfXdpConntrackNat64PrefixKey struct {
	_      structs.HostLayout
	Prefix [3]uint32
}

type xpfXdpConntrackNat64StateKey struct {
	_        structs.HostLayout
	SrcIp    uint32
	DstIp    uint32
	SrcPort  uint16
...
type xpfXdpConntrackNat64StateValue struct {
	_           structs.HostLayout
	OrigSrcV6   [16]uint8
	OrigDstV6   [16]uint8
	OrigSrcPort uint16
...
type xpfXdpConntrackNptv6Key struct {
	_         structs.HostLayout
	Prefix    [8]uint8
	Direction uint8
	PrefixLen uint8
...
type xpfXdpConntrackNptv6Value struct {
	_           structs.HostLayout
	XlatPrefix  [8]uint8
	Adjustment  uint16
	PrefixWords uint8
...
type xpfXdpConntrackPktMeta struct {
	_     structs.HostLayout
	SrcIp struct {
		_  structs.HostLayout
		V4 uint32
...
type xpfXdpConntrackPolicerConfig struct {
	_            structs.HostLayout
	RateBytesSec uint64
	BurstBytes   uint64
	Action       uint8
...
type xpfXdpConntrackPolicerState struct {
	_            structs.HostLayout
	Tokens       uint64
	LastRefillNs uint64
	PeakTokens   uint64
...
type xpfXdpConntrackPolicyRule struct {
	_           structs.HostLayout
	RuleId      uint32
	PolicySetId uint32
	Sequence    uint16
...
type xpfXdpConntrackPolicySet struct {
	_             structs.HostLayout
	PolicySetId   uint32
	NumRules      uint16
...
type xpfXdpConntrackScanTrackKey struct {
	_      structs.HostLayout
	SrcIp  uint32
	ZoneId uint16
	Pad    uint16
...
type xpfXdpConntrackScanTrackValue struct {
	_           structs.HostLayout
	Count       uint32
	WindowStart uint32
}

type xpfXdpConntrackScreenConfig struct {
	_                 structs.HostLayout
	Flags             uint32
...
type xpfXdpConntrackSessionCountKey struct {
	_      structs.HostLayout
	Ip     uint32
	ZoneId uint16
	Pad    uint16
...
type xpfXdpConntrackSessionCountValue struct {
	_     structs.HostLayout
	Count uint32
}

type xpfXdpConntrackSessionKey struct {
	_        structs.HostLayout
	SrcIp    uint32
	DstIp    uint32
	SrcPort  uint16
...
type xpfXdpConntrackSessionKeyV6 struct {
	_        structs.HostLayout
	SrcIp    [16]uint8
	DstIp    [16]uint8
	SrcPort  uint16
...
type xpfXdpConntrackSessionValue struct {
	_           structs.HostLayout
	State       uint8
	Flags       uint8
	TcpState    uint8
	...
	RevPackets  uint64
	RevBytes    uint64
	ReverseKey  xpfXdpConntrackSessionKey
	AlgType     uint8
	LogFlags    uint8
	AppId       uint16
	FibIfindex  uint32
...
type xpfXdpConntrackSessionValueV6 struct {
	_           structs.HostLayout
	State       uint8
	Flags       uint8
	TcpState    uint8
	...
	RevPackets  uint64
	RevBytes    uint64
	ReverseKey  xpfXdpConntrackSessionKeyV6
	AlgType     uint8
	LogFlags    uint8
	AppId       uint16
	FibIfindex  uint32
...
type xpfXdpConntrackSnatEgressKey struct {
	_       structs.HostLayout
	Ifindex uint32
	VlanId  uint16
	Pad     uint16
...
type xpfXdpConntrackSnatEgressValue struct {
	_    structs.HostLayout
	Ipv4 uint32
	Ipv6 [16]uint8
}

type xpfXdpConntrackSnatValue struct {
	_         structs.HostLayout
	SnatIp    uint32
	SrcAddrId uint32
	DstAddrId uint32
...
type xpfXdpConntrackSnatValueV6 struct {
	_         structs.HostLayout
	SnatIp    [16]uint8
	SrcAddrId uint32
	DstAddrId uint32
...
type xpfXdpConntrackStaticNatKeyV4 struct {
	_         structs.HostLayout
	Ip        uint32
	Direction uint8
	Pad       [3]uint8
...
type xpfXdpConntrackStaticNatKeyV6 struct {
	_         structs.HostLayout
	Ip        [16]uint8
	Direction uint8
	Pad       [3]uint8
...
type xpfXdpConntrackStaticNatValueV6 struct {
	_  structs.HostLayout
	Ip [16]uint8
}

type xpfXdpConntrackValidatedClientKey struct {
	_       structs.HostLayout
	SrcIp   uint32
	DstIp   uint32
	DstPort uint16
...
type xpfXdpConntrackValidatedClientValue struct {
	_           structs.HostLayout
	ValidatedAt uint64
}

type xpfXdpConntrackVlanIfaceInfo struct {
	_             structs.HostLayout
...
type xpfXdpConntrackZoneConfig struct {
	_                structs.HostLayout
	ZoneId           uint16
...
// xpfXdpConntrackSpecs contains maps and programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type xpfXdpConntrackSpecs struct {
	xpfXdpConntrackProgramSpecs
	xpfXdpConntrackMapSpecs
	xpfXdpConntrackVariableSpecs
}

// xpfXdpConntrackProgramSpecs contains programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type xpfXdpConntrackProgramSpecs struct {
	XdpConntrackProg *ebpf.ProgramSpec `ebpf:"xdp_conntrack_prog"`
}

// xpfXdpConntrackMapSpecs contains maps before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type xpfXdpConntrackMapSpecs struct {
...
// xpfXdpConntrackVariableSpecs contains global variables before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type xpfXdpConntrackVariableSpecs struct {
}
