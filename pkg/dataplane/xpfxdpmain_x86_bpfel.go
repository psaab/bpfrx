...
type xpfXdpMainAddrMembershipKey struct {
	_         structs.HostLayout
	Ip        uint32
	AddressId uint32
}

type xpfXdpMainAddrValue struct {
	_         structs.HostLayout
	AddressId uint32
}

type xpfXdpMainAppKey struct {
	_        structs.HostLayout
	Protocol uint8
	Pad      uint8
	DstPort  uint16
...
type xpfXdpMainAppRangeEntry struct {
	_           structs.HostLayout
	Protocol    uint8
	AlgType     uint8
	PortLow     uint16
...
type xpfXdpMainAppValue struct {
	_           structs.HostLayout
	AppId       uint32
	AlgType     uint8
	Pad         uint8
...
type xpfXdpMainBpfDevmapVal struct {
	_       structs.HostLayout
	Ifindex uint32
	BpfProg struct {
		_  structs.HostLayout
...
type xpfXdpMainCounterValue struct {
	_       structs.HostLayout
	Packets uint64
	Bytes   uint64
}

type xpfXdpMainCpumapVal struct {
	_         structs.HostLayout
	Qsize     uint32
	BpfProgFd uint32
}

type xpfXdpMainDnatKey struct {
	_        structs.HostLayout
	Protocol uint8
	Pad      [3]uint8
	DstIp    uint32
...
type xpfXdpMainDnatValueV6 struct {
	_          structs.HostLayout
	NewDstIp   [16]uint8
	NewDstPort uint16
	Flags      uint8
...
type xpfXdpMainFabricFwdInfo struct {
	_          structs.HostLayout
	Ifindex    uint32
	FibIfindex uint32
	PeerMac    [6]uint8
...
type xpfXdpMainFilterConfig struct {
	_            structs.HostLayout
	NumRules     uint32
	RuleStart    uint32
	AllHaveProto uint8
...
type xpfXdpMainFilterRule struct {
	_            structs.HostLayout
	MatchFlags   uint16
	Dscp         uint8
	Protocol     uint8
...
type xpfXdpMainFloodState struct {
	_              structs.HostLayout
	SynCount       uint64
	IcmpCount      uint64
	UdpCount       uint64
...
type xpfXdpMainFlowConfig struct {
	_                 structs.HostLayout
	TcpMssIpsec       uint16
	TcpMssGreIn       uint16
	TcpMssGreOut      uint16
...
type xpfXdpMainIfaceCounterValue struct {
	_         structs.HostLayout
	RxPackets uint64
	RxBytes   uint64
	TxPackets uint64
...
type xpfXdpMainIfaceFilterKey struct {
	_         structs.HostLayout
	Ifindex   uint32
	VlanId    uint16
	Family    uint8
...
type xpfXdpMainIfaceZoneKey struct {
	_       structs.HostLayout
	Ifindex uint32
	VlanId  uint16
	Pad     uint16
...
type xpfXdpMainIfaceZoneValue struct {
	_            structs.HostLayout
	ZoneId       uint16
	Flags        uint8
	RgId         uint8
...
type xpfXdpMainLpmKeyV4 struct {
	_         structs.HostLayout
	Prefixlen uint32
	Addr      uint32
}

type xpfXdpMainLpmKeyV6 struct {
	_         structs.HostLayout
	Prefixlen uint32
	Addr      [16]uint8
}

type xpfXdpMainMirrorConfig struct {
	_             structs.HostLayout
	MirrorIfindex uint32
	Rate          uint32
}

type xpfXdpMainNat64Config struct {
	_          structs.HostLayout
	Prefix     [3]uint32
	SnatPoolId uint8
	Pad        [3]uint8
...
type xpfXdpMainNat64FibCacheKey struct {
	_       structs.HostLayout
	Ipv4Dst uint32
	Tbid    uint32
}

type xpfXdpMainNat64FibCacheVal struct {
	_       structs.HostLayout
	Ifindex uint32
	VlanId  uint16
	Gen     uint16
...
type xpfXdpMainNat64PrefixKey struct {
	_      structs.HostLayout
	Prefix [3]uint32
}

type xpfXdpMainNat64StateKey struct {
	_        structs.HostLayout
	SrcIp    uint32
	DstIp    uint32
	SrcPort  uint16
...
type xpfXdpMainNat64StateValue struct {
	_           structs.HostLayout
	OrigSrcV6   [16]uint8
	OrigDstV6   [16]uint8
	OrigSrcPort uint16
...
type xpfXdpMainNatPoolConfig struct {
	_              structs.HostLayout
	NumIps         uint16
	NumIpsV6       uint16
	PortLow        uint16
...
type xpfXdpMainNatPoolIpV6 struct {
	_  structs.HostLayout
	Ip [16]uint8
}

type xpfXdpMainNatPortCounter struct {
	_       structs.HostLayout
	Counter uint64
}

type xpfXdpMainNptv6Key struct {
	_         structs.HostLayout
	Prefix    [8]uint8
	Direction uint8
	PrefixLen uint8
...
type xpfXdpMainNptv6Value struct {
	_           structs.HostLayout
	XlatPrefix  [8]uint8
	Adjustment  uint16
	PrefixWords uint8
...
type xpfXdpMainPolicerConfig struct {
	_            structs.HostLayout
	RateBytesSec uint64
	BurstBytes   uint64
	Action       uint8
...
type xpfXdpMainPolicerState struct {
	_            structs.HostLayout
	Tokens       uint64
	LastRefillNs uint64
	PeakTokens   uint64
...
type xpfXdpMainPolicyRule struct {
	_           structs.HostLayout
	RuleId      uint32
	PolicySetId uint32
	Sequence    uint16
...
type xpfXdpMainPolicySet struct {
	_             structs.HostLayout
	PolicySetId   uint32
	NumRules      uint16
...
type xpfXdpMainScanTrackKey struct {
	_      structs.HostLayout
	SrcIp  uint32
	ZoneId uint16
	Pad    uint16
...
type xpfXdpMainScanTrackValue struct {
	_           structs.HostLayout
	Count       uint32
	WindowStart uint32
}

type xpfXdpMainScreenConfig struct {
	_                 structs.HostLayout
	Flags             uint32
...
type xpfXdpMainSessionCountKey struct {
	_      structs.HostLayout
	Ip     uint32
	ZoneId uint16
	Pad    uint16
...
type xpfXdpMainSessionCountValue struct {
	_     structs.HostLayout
	Count uint32
}

type xpfXdpMainSessionKey struct {
	_        structs.HostLayout
	SrcIp    uint32
	DstIp    uint32
	SrcPort  uint16
...
type xpfXdpMainSessionKeyV6 struct {
	_        structs.HostLayout
	SrcIp    [16]uint8
	DstIp    [16]uint8
	SrcPort  uint16
...
type xpfXdpMainSessionValue struct {
	_           structs.HostLayout
	State       uint8
	Flags       uint8
	TcpState    uint8
	...
	RevPackets  uint64
	RevBytes    uint64
	ReverseKey  xpfXdpMainSessionKey
	AlgType     uint8
	LogFlags    uint8
	AppId       uint16
	FibIfindex  uint32
...
type xpfXdpMainSessionValueV6 struct {
	_           structs.HostLayout
	State       uint8
	Flags       uint8
	TcpState    uint8
	...
	RevPackets  uint64
	RevBytes    uint64
	ReverseKey  xpfXdpMainSessionKeyV6
	AlgType     uint8
	LogFlags    uint8
	AppId       uint16
	FibIfindex  uint32
...
type xpfXdpMainSnatEgressKey struct {
	_       structs.HostLayout
	Ifindex uint32
	VlanId  uint16
	Pad     uint16
...
type xpfXdpMainSnatEgressValue struct {
	_    structs.HostLayout
	Ipv4 uint32
	Ipv6 [16]uint8
}

type xpfXdpMainSnatValue struct {
	_         structs.HostLayout
	SnatIp    uint32
	SrcAddrId uint32
	DstAddrId uint32
...
type xpfXdpMainSnatValueV6 struct {
	_         structs.HostLayout
	SnatIp    [16]uint8
	SrcAddrId uint32
	DstAddrId uint32
...
type xpfXdpMainStaticNatKeyV4 struct {
	_         structs.HostLayout
	Ip        uint32
	Direction uint8
	Pad       [3]uint8
...
type xpfXdpMainStaticNatKeyV6 struct {
	_         structs.HostLayout
	Ip        [16]uint8
	Direction uint8
	Pad       [3]uint8
...
type xpfXdpMainStaticNatValueV6 struct {
	_  structs.HostLayout
	Ip [16]uint8
}

type xpfXdpMainValidatedClientKey struct {
	_       structs.HostLayout
	SrcIp   [16]uint8
	DstIp   [16]uint8
	DstPort uint16
...
type xpfXdpMainValidatedClientValue struct {
	_           structs.HostLayout
	ValidatedAt uint64
}

type xpfXdpMainVlanIfaceInfo struct {
	_             structs.HostLayout
...
type xpfXdpMainZoneConfig struct {
	_                structs.HostLayout
	ZoneId           uint16
...
// xpfXdpMainSpecs contains maps and programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type xpfXdpMainSpecs struct {
	xpfXdpMainProgramSpecs
	xpfXdpMainMapSpecs
	xpfXdpMainVariableSpecs
}

// xpfXdpMainProgramSpecs contains programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type xpfXdpMainProgramSpecs struct {
	XdpMainProg *ebpf.ProgramSpec `ebpf:"xdp_main_prog"`
}

// xpfXdpMainMapSpecs contains maps before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type xpfXdpMainMapSpecs struct {
...
// xpfXdpMainVariableSpecs contains global variables before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type xpfXdpMainVariableSpecs struct {
}
