...
type bpfrxXdpMainAppRangeEntry struct {
	_           structs.HostLayout
	Protocol    uint8
	AlgType     uint8
	PortLow     uint16
...
type bpfrxXdpMainFabricFwdInfo struct {
	_          structs.HostLayout
	Ifindex    uint32
	FibIfindex uint32
	PeerMac    [6]uint8
...
type bpfrxXdpMainNat64FibCacheKey struct {
	_       structs.HostLayout
	Ipv4Dst uint32
	Tbid    uint32
}

type bpfrxXdpMainNat64FibCacheVal struct {
	_       structs.HostLayout
	Ifindex uint32
	VlanId  uint16
	Gen     uint16
...
type bpfrxXdpMainRstSuppressV6Key struct {
	_    structs.HostLayout
	Addr [16]uint8
}
...
type bpfrxXdpMainSessionCountKey struct {
	_      structs.HostLayout
	Ip     uint32
	ZoneId uint16
	Pad    uint16
...
type bpfrxXdpMainSessionCountValue struct {
	_     structs.HostLayout
	Count uint32
}
...
type bpfrxXdpMainSnatEgressKey struct {
	_       structs.HostLayout
	Ifindex uint32
	VlanId  uint16
	Pad     uint16
...
type bpfrxXdpMainSnatEgressValue struct {
	_    structs.HostLayout
	Ipv4 uint32
	Ipv6 [16]uint8
}
...
type bpfrxXdpMainValidatedClientKey struct {
	_       structs.HostLayout
	SrcIp   uint32
	DstIp   uint32
	DstPort uint16
...
type bpfrxXdpMainValidatedClientValue struct {
	_           structs.HostLayout
	ValidatedAt uint64
}
