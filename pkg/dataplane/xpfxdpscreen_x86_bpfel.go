...
type xpfXdpScreenAddrMembershipKey struct {
	_         structs.HostLayout
	Ip        uint32
	AddressId uint32
}

type xpfXdpScreenAddrValue struct {
	_         structs.HostLayout
	AddressId uint32
}

type xpfXdpScreenAppKey struct {
	_        structs.HostLayout
	Protocol uint8
	Pad      uint8
	DstPort  uint16
...
type xpfXdpScreenAppRangeEntry struct {
	_           structs.HostLayout
	Protocol    uint8
	AlgType     uint8
	PortLow     uint16
...
type xpfXdpScreenAppValue struct {
	_           structs.HostLayout
	AppId       uint32
	AlgType     uint8
	Pad         uint8
...
type xpfXdpScreenBpfDevmapVal struct {
	_       structs.HostLayout
	Ifindex uint32
	BpfProg struct {
		_  structs.HostLayout
...
type xpfXdpScreenCounterValue struct {
	_       structs.HostLayout
	Packets uint64
	Bytes   uint64
}

type xpfXdpScreenCpumapVal struct {
	_         structs.HostLayout
	Qsize     uint32
	BpfProgFd uint32
}

type xpfXdpScreenDnatKey struct {
	_        structs.HostLayout
	Protocol uint8
	Pad      [3]uint8
	DstIp    uint32
...
type xpfXdpScreenDnatValueV6 struct {
	_          structs.HostLayout
	NewDstIp   [16]uint8
	NewDstPort uint16
	Flags      uint8
...
type xpfXdpScreenFabricFwdInfo struct {
	_          structs.HostLayout
	Ifindex    uint32
	FibIfindex uint32
	PeerMac    [6]uint8
...
type xpfXdpScreenFilterConfig struct {
	_            structs.HostLayout
	NumRules     uint32
	RuleStart    uint32
	AllHaveProto uint8
...
type xpfXdpScreenFilterRule struct {
	_            structs.HostLayout
	MatchFlags   uint16
	Dscp         uint8
	Protocol     uint8
...
type xpfXdpScreenFloodState struct {
	_              structs.HostLayout
	SynCount       uint64
	IcmpCount      uint64
	UdpCount       uint64
...
type xpfXdpScreenFlowConfig struct {
	_                 structs.HostLayout
	TcpMssIpsec       uint16
	TcpMssGreIn       uint16
	TcpMssGreOut      uint16
...
type xpfXdpScreenIfaceCounterValue struct {
	_         structs.HostLayout
	RxPackets uint64
	RxBytes   uint64
	TxPackets uint64
...
type xpfXdpScreenIfaceFilterKey struct {
	_         structs.HostLayout
	Ifindex   uint32
	VlanId    uint16
	Family    uint8
...
type xpfXdpScreenIfaceZoneKey struct {
	_       structs.HostLayout
	Ifindex uint32
	VlanId  uint16
	Pad     uint16
...
type xpfXdpScreenIfaceZoneValue struct {
	_            structs.HostLayout
	ZoneId       uint16
	Flags        uint8
	RgId         uint8
...
type xpfXdpScreenLpmKeyV4 struct {
	_         structs.HostLayout
	Prefixlen uint32
	Addr      uint32
}

type xpfXdpScreenLpmKeyV6 struct {
	_         structs.HostLayout
	Prefixlen uint32
	Addr      [16]uint8
}

type xpfXdpScreenMirrorConfig struct {
	_             structs.HostLayout
	MirrorIfindex uint32
	Rate          uint32
}

type xpfXdpScreenNat64Config struct {
	_          structs.HostLayout
	Prefix     [3]uint32
	SnatPoolId uint8
	Pad        [3]uint8
...
type xpfXdpScreenNat64FibCacheKey struct {
	_       structs.HostLayout
	Ipv4Dst uint32
	Tbid    uint32
}

type xpfXdpScreenNat64FibCacheVal struct {
	_       structs.HostLayout
	Ifindex uint32
	VlanId  uint16
	Gen     uint16
...
type xpfXdpScreenNat64PrefixKey struct {
	_      structs.HostLayout
	Prefix [3]uint32
}

type xpfXdpScreenNat64StateKey struct {
	_        structs.HostLayout
	SrcIp    uint32
	DstIp    uint32
	SrcPort  uint16
...
type xpfXdpScreenNat64StateValue struct {
	_           structs.HostLayout
	OrigSrcV6   [16]uint8
	OrigDstV6   [16]uint8
	OrigSrcPort uint16
...
type xpfXdpScreenNptv6Key struct {
	_         structs.HostLayout
	Prefix    [8]uint8
	Direction uint8
	PrefixLen uint8
...
type xpfXdpScreenNptv6Value struct {
	_           structs.HostLayout
	XlatPrefix  [8]uint8
	Adjustment  uint16
	PrefixWords uint8
...
type xpfXdpScreenPktMeta struct {
	_     structs.HostLayout
	SrcIp struct {
		_  structs.HostLayout
		V4 uint32
...
type xpfXdpScreenPolicerConfig struct {
	_            structs.HostLayout
	RateBytesSec uint64
	BurstBytes   uint64
	Action       uint8
...
type xpfXdpScreenPolicerState struct {
	_            structs.HostLayout
	Tokens       uint64
	LastRefillNs uint64
	PeakTokens   uint64
...
type xpfXdpScreenPolicyRule struct {
	_           structs.HostLayout
	RuleId      uint32
	PolicySetId uint32
	Sequence    uint16
...
type xpfXdpScreenPolicySet struct {
	_             structs.HostLayout
	PolicySetId   uint32
	NumRules      uint16
...
type xpfXdpScreenScanTrackKey struct {
	_      structs.HostLayout
	SrcIp  uint32
	ZoneId uint16
	Pad    uint16
...
type xpfXdpScreenScanTrackValue struct {
	_           structs.HostLayout
	Count       uint32
	WindowStart uint32
}

type xpfXdpScreenScreenConfig struct {
	_                 structs.HostLayout
	Flags             uint32
...
type xpfXdpScreenSessionCountKey struct {
	_      structs.HostLayout
	Ip     uint32
	ZoneId uint16
	Pad    uint16
...
type xpfXdpScreenSessionCountValue struct {
	_     structs.HostLayout
	Count uint32
}

type xpfXdpScreenSessionKey struct {
	_        structs.HostLayout
	SrcIp    uint32
	DstIp    uint32
	SrcPort  uint16
...
type xpfXdpScreenSessionKeyV6 struct {
	_        structs.HostLayout
	SrcIp    [16]uint8
	DstIp    [16]uint8
	SrcPort  uint16
...
type xpfXdpScreenSessionValue struct {
	_           structs.HostLayout
	State       uint8
	Flags       uint8
	TcpState    uint8
	...
	RevPackets  uint64
	RevBytes    uint64
	ReverseKey  xpfXdpScreenSessionKey
	AlgType     uint8
	LogFlags    uint8
	AppId       uint16
	FibIfindex  uint32
...
type xpfXdpScreenSessionValueV6 struct {
	_           structs.HostLayout
	State       uint8
	Flags       uint8
	TcpState    uint8
	...
	RevPackets  uint64
	RevBytes    uint64
	ReverseKey  xpfXdpScreenSessionKeyV6
	AlgType     uint8
	LogFlags    uint8
	AppId       uint16
	FibIfindex  uint32
...
type xpfXdpScreenSnatEgressKey struct {
	_       structs.HostLayout
	Ifindex uint32
	VlanId  uint16
	Pad     uint16
...
type xpfXdpScreenSnatEgressValue struct {
	_    structs.HostLayout
	Ipv4 uint32
	Ipv6 [16]uint8
}

type xpfXdpScreenSnatValue struct {
	_         structs.HostLayout
	SnatIp    uint32
	SrcAddrId uint32
	DstAddrId uint32
...
type xpfXdpScreenSnatValueV6 struct {
	_         structs.HostLayout
	SnatIp    [16]uint8
	SrcAddrId uint32
	DstAddrId uint32
...
type xpfXdpScreenStaticNatKeyV4 struct {
	_         structs.HostLayout
	Ip        uint32
	Direction uint8
	Pad       [3]uint8
...
type xpfXdpScreenStaticNatKeyV6 struct {
	_         structs.HostLayout
	Ip        [16]uint8
	Direction uint8
	Pad       [3]uint8
...
type xpfXdpScreenStaticNatValueV6 struct {
	_  structs.HostLayout
	Ip [16]uint8
}

type xpfXdpScreenValidatedClientKey struct {
	_       structs.HostLayout
	SrcIp   [16]uint8
	DstIp   [16]uint8
	DstPort uint16
...
type xpfXdpScreenValidatedClientValue struct {
	_           structs.HostLayout
	ValidatedAt uint64
}

type xpfXdpScreenVlanIfaceInfo struct {
	_             structs.HostLayout
...
type xpfXdpScreenZoneConfig struct {
	_                structs.HostLayout
	ZoneId           uint16
...
// xpfXdpScreenSpecs contains maps and programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type xpfXdpScreenSpecs struct {
	xpfXdpScreenProgramSpecs
	xpfXdpScreenMapSpecs
	xpfXdpScreenVariableSpecs
}

// xpfXdpScreenProgramSpecs contains programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type xpfXdpScreenProgramSpecs struct {
	XdpScreenProg *ebpf.ProgramSpec `ebpf:"xdp_screen_prog"`
}

// xpfXdpScreenMapSpecs contains maps before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type xpfXdpScreenMapSpecs struct {
...
// xpfXdpScreenVariableSpecs contains global variables before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type xpfXdpScreenVariableSpecs struct {
}
