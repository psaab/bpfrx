...
type bpfrxXdpPolicyAppRangeEntry struct {
	_           structs.HostLayout
	Protocol    uint8
	AlgType     uint8
	PortLow     uint16
...
type bpfrxXdpPolicyFabricFwdInfo struct {
	_          structs.HostLayout
	Ifindex    uint32
	FibIfindex uint32
	PeerMac    [6]uint8
...
type bpfrxXdpPolicyMirrorConfig struct {
	_             structs.HostLayout
...
type bpfrxXdpPolicyNat64FibCacheKey struct {
	_       structs.HostLayout
	Ipv4Dst uint32
	Tbid    uint32
}

type bpfrxXdpPolicyNat64FibCacheVal struct {
	_       structs.HostLayout
	Ifindex uint32
	VlanId  uint16
	Gen     uint16
...
type bpfrxXdpPolicyNptv6Key struct {
	_         structs.HostLayout
	Prefix    [8]uint8
	Direction uint8
	PrefixLen uint8
...
type bpfrxXdpPolicyNptv6Value struct {
	_           structs.HostLayout
	XlatPrefix  [8]uint8
	Adjustment  uint16
	PrefixWords uint8
...
type bpfrxXdpPolicyPolicerConfig struct {
	_            structs.HostLayout
	RateBytesSec uint64
	BurstBytes   uint64
	Action       uint8
...
type bpfrxXdpPolicyPolicerState struct {
	_            structs.HostLayout
	Tokens       uint64
	LastRefillNs uint64
	PeakTokens   uint64
...
type bpfrxXdpPolicyRstSuppressV6Key struct {
	_    structs.HostLayout
	Addr [16]uint8
}
...
type bpfrxXdpPolicyValidatedClientKey struct {
	_       structs.HostLayout
	SrcIp   uint32
	DstIp   uint32
	DstPort uint16
...
type bpfrxXdpPolicyValidatedClientValue struct {
	_           structs.HostLayout
	ValidatedAt uint64
}
