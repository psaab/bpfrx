...
type xpfTcConntrackAddrMembershipKey struct {
	_         structs.HostLayout
	Ip        uint32
	AddressId uint32
}

type xpfTcConntrackAddrValue struct {
	_         structs.HostLayout
	AddressId uint32
}

type xpfTcConntrackAppKey struct {
	_        structs.HostLayout
	Protocol uint8
	Pad      uint8
	DstPort  uint16
...
type xpfTcConntrackAppRangeEntry struct {
	_           structs.HostLayout
	Protocol    uint8
	AlgType     uint8
	PortLow     uint16
...
type xpfTcConntrackAppValue struct {
	_           structs.HostLayout
	AppId       uint32
	AlgType     uint8
	Pad         uint8
...
type xpfTcConntrackBpfDevmapVal struct {
	_       structs.HostLayout
	Ifindex uint32
	BpfProg struct {
		_  structs.HostLayout
...
type xpfTcConntrackCounterValue struct {
	_       structs.HostLayout
	Packets uint64
	Bytes   uint64
}

type xpfTcConntrackCpumapVal struct {
	_         structs.HostLayout
	Qsize     uint32
	BpfProgFd uint32
}

type xpfTcConntrackDnatKey struct {
	_        structs.HostLayout
	Protocol uint8
	Pad      [3]uint8
	DstIp    uint32
...
type xpfTcConntrackDnatKeyV6 struct {
	_        structs.HostLayout
	Protocol uint8
	Pad      [3]uint8
	DstIp    [16]uint8
...
type xpfTcConntrackDnatValue struct {
	_          structs.HostLayout
	NewDstIp   uint32
	NewDstPort uint16
	Flags      uint8
...
type xpfTcConntrackDnatValueV6 struct {
	_          structs.HostLayout
	NewDstIp   [16]uint8
	NewDstPort uint16
	Flags      uint8
...
type xpfTcConntrackFabricFwdInfo struct {
	_          structs.HostLayout
	Ifindex    uint32
	FibIfindex uint32
	PeerMac    [6]uint8
...
type xpfTcConntrackFilterConfig struct {
	_            structs.HostLayout
	NumRules     uint32
	RuleStart    uint32
	AllHaveProto uint8
...
type xpfTcConntrackFilterRule struct {
	_            structs.HostLayout
	MatchFlags   uint16
	Dscp         uint8
	Protocol     uint8
...
type xpfTcConntrackFloodState struct {
	_              structs.HostLayout
	SynCount       uint64
	IcmpCount      uint64
	UdpCount       uint64
...
type xpfTcConntrackFlowConfig struct {
	_                 structs.HostLayout
	TcpMssIpsec       uint16
	TcpMssGreIn       uint16
	TcpMssGreOut      uint16
...
type xpfTcConntrackIfaceCounterValue struct {
	_         structs.HostLayout
	RxPackets uint64
	RxBytes   uint64
	TxPackets uint64
...
type xpfTcConntrackIfaceFilterKey struct {
	_         structs.HostLayout
	Ifindex   uint32
	VlanId    uint16
	Family    uint8
...
type xpfTcConntrackIfaceZoneKey struct {
	_       structs.HostLayout
	Ifindex uint32
	VlanId  uint16
	Pad     uint16
...
type xpfTcConntrackIfaceZoneValue struct {
	_            structs.HostLayout
	ZoneId       uint16
	Flags        uint8
	RgId         uint8
...
type xpfTcConntrackLpmKeyV4 struct {
	_         structs.HostLayout
	Prefixlen uint32
	Addr      uint32
}

type xpfTcConntrackLpmKeyV6 struct {
	_         structs.HostLayout
	Prefixlen uint32
	Addr      [16]uint8
}

type xpfTcConntrackMirrorConfig struct {
	_             structs.HostLayout
	MirrorIfindex uint32
	Rate          uint32
}

type xpfTcConntrackNat64Config struct {
	_          structs.HostLayout
	Prefix     [3]uint32
	SnatPoolId uint8
	Pad        [3]uint8
...
type xpfTcConntrackNat64FibCacheKey struct {
	_       structs.HostLayout
	Ipv4Dst uint32
	Tbid    uint32
}

type xpfTcConntrackNat64FibCacheVal struct {
	_       structs.HostLayout
	Ifindex uint32
	VlanId  uint16
	Gen     uint16
...
type xpfTcConntrackNat64PrefixKey struct {
	_      structs.HostLayout
	Prefix [3]uint32
}

type xpfTcConntrackNat64StateKey struct {
	_        structs.HostLayout
	SrcIp    uint32
	DstIp    uint32
	SrcPort  uint16
...
type xpfTcConntrackNat64StateValue struct {
	_           structs.HostLayout
	OrigSrcV6   [16]uint8
	OrigDstV6   [16]uint8
	OrigSrcPort uint16
...
type xpfTcConntrackNptv6Key struct {
	_         structs.HostLayout
	Prefix    [8]uint8
	Direction uint8
	PrefixLen uint8
...
type xpfTcConntrackNptv6Value struct {
	_           structs.HostLayout
	XlatPrefix  [8]uint8
	Adjustment  uint16
	PrefixWords uint8
...
type xpfTcConntrackPktMeta struct {
	_     structs.HostLayout
	SrcIp struct {
		_  structs.HostLayout
		V4 uint32
...
type xpfTcConntrackPolicerConfig struct {
	_            structs.HostLayout
	RateBytesSec uint64
	BurstBytes   uint64
	Action       uint8
...
type xpfTcConntrackPolicerState struct {
	_            structs.HostLayout
	Tokens       uint64
	LastRefillNs uint64
	PeakTokens   uint64
...
type xpfTcConntrackPolicyRule struct {
	_           structs.HostLayout
	RuleId      uint32
	PolicySetId uint32
	Sequence    uint16
...
type xpfTcConntrackPolicySet struct {
	_             structs.HostLayout
	PolicySetId   uint32
	NumRules      uint16
...
type xpfTcConntrackScanTrackKey struct {
	_      structs.HostLayout
	SrcIp  uint32
	ZoneId uint16
	Pad    uint16
...
type xpfTcConntrackScanTrackValue struct {
	_           structs.HostLayout
	Count       uint32
	WindowStart uint32
}

type xpfTcConntrackScreenConfig struct {
	_                 structs.HostLayout
	Flags             uint32
...
type xpfTcConntrackSessionCountKey struct {
	_      structs.HostLayout
	Ip     uint32
	ZoneId uint16
	Pad    uint16
...
type xpfTcConntrackSessionCountValue struct {
	_     structs.HostLayout
	Count uint32
}

type xpfTcConntrackSessionKey struct {
	_        structs.HostLayout
	SrcIp    uint32
	DstIp    uint32
	SrcPort  uint16
...
type xpfTcConntrackSessionKeyV6 struct {
	_        structs.HostLayout
	SrcIp    [16]uint8
	DstIp    [16]uint8
	SrcPort  uint16
...
type xpfTcConntrackSessionValue struct {
	_           structs.HostLayout
	State       uint8
	Flags       uint8
	TcpState    uint8
	...
	RevPackets  uint64
	RevBytes    uint64
	ReverseKey  xpfTcConntrackSessionKey
	AlgType     uint8
	LogFlags    uint8
	AppId       uint16
	FibIfindex  uint32
...
type xpfTcConntrackSessionValueV6 struct {
	_           structs.HostLayout
	State       uint8
	Flags       uint8
	TcpState    uint8
	...
	RevPackets  uint64
	RevBytes    uint64
	ReverseKey  xpfTcConntrackSessionKeyV6
	AlgType     uint8
	LogFlags    uint8
	AppId       uint16
	FibIfindex  uint32
...
type xpfTcConntrackSnatEgressKey struct {
	_       structs.HostLayout
	Ifindex uint32
	VlanId  uint16
	Pad     uint16
...
type xpfTcConntrackSnatEgressValue struct {
	_    structs.HostLayout
	Ipv4 uint32
	Ipv6 [16]uint8
}

type xpfTcConntrackSnatValue struct {
	_         structs.HostLayout
	SnatIp    uint32
	SrcAddrId uint32
	DstAddrId uint32
...
type xpfTcConntrackSnatValueV6 struct {
	_         structs.HostLayout
	SnatIp    [16]uint8
	SrcAddrId uint32
	DstAddrId uint32
...
type xpfTcConntrackStaticNatKeyV4 struct {
	_         structs.HostLayout
	Ip        uint32
	Direction uint8
	Pad       [3]uint8
...
type xpfTcConntrackStaticNatKeyV6 struct {
	_         structs.HostLayout
	Ip        [16]uint8
	Direction uint8
	Pad       [3]uint8
...
type xpfTcConntrackStaticNatValueV6 struct {
	_  structs.HostLayout
	Ip [16]uint8
}

type xpfTcConntrackValidatedClientKey struct {
	_       structs.HostLayout
	SrcIp   uint32
	DstIp   uint32
	DstPort uint16
...
type xpfTcConntrackValidatedClientValue struct {
	_           structs.HostLayout
	ValidatedAt uint64
}

type xpfTcConntrackVlanIfaceInfo struct {
	_             structs.HostLayout
...
type xpfTcConntrackZoneConfig struct {
	_                structs.HostLayout
	ZoneId           uint16
...
// loadXpfTcConntrack returns the embedded CollectionSpec for xpfTcConntrack.
func loadXpfTcConntrack() (*ebpf.CollectionSpec, error) {
	reader := bytes.NewReader(_XpfTcConntrackBytes)
	spec, err := ebpf.LoadCollectionSpecFromReader(reader)
	if err != nil {
		return nil, fmt.Errorf("can't load xpfTcConntrack: %w", err)
	}

	return spec, err
}

// loadXpfTcConntrackObjects loads xpfTcConntrack and converts it into a struct.
//
// The following types are suitable as obj argument:
//
//	*xpfTcConntrackObjects
//	*xpfTcConntrackPrograms
//	*xpfTcConntrackMaps
//
// See ebpf.CollectionSpec.LoadAndAssign documentation for details.
func loadXpfTcConntrackObjects(obj interface{}, opts *ebpf.CollectionOptions) error {
	spec, err := loadXpfTcConntrack()
	if err != nil {
		return err
	}
...
// xpfTcConntrackSpecs contains maps and programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type xpfTcConntrackSpecs struct {
	xpfTcConntrackProgramSpecs
	xpfTcConntrackMapSpecs
	xpfTcConntrackVariableSpecs
}

// xpfTcConntrackProgramSpecs contains programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type xpfTcConntrackProgramSpecs struct {
	TcConntrackProg *ebpf.ProgramSpec `ebpf:"tc_conntrack_prog"`
}

// xpfTcConntrackMapSpecs contains maps before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type xpfTcConntrackMapSpecs struct {
...
// xpfTcConntrackVariableSpecs contains global variables before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type xpfTcConntrackVariableSpecs struct {
}

// xpfTcConntrackObjects contains all objects after they have been loaded into the kernel.
//
// It can be passed to loadXpfTcConntrackObjects or ebpf.CollectionSpec.LoadAndAssign.
type xpfTcConntrackObjects struct {
	xpfTcConntrackPrograms
	xpfTcConntrackMaps
	xpfTcConntrackVariables
}

func (o *xpfTcConntrackObjects) Close() error {
	return _XpfTcConntrackClose(
		&o.xpfTcConntrackPrograms,
		&o.xpfTcConntrackMaps,
	)
}

// xpfTcConntrackMaps contains all maps after they have been loaded into the kernel.
//
// It can be passed to loadXpfTcConntrackObjects or ebpf.CollectionSpec.LoadAndAssign.
type xpfTcConntrackMaps struct {
...
func (m *xpfTcConntrackMaps) Close() error {
	return _XpfTcConntrackClose(
		m.AddressBookV4,
		m.AddressBookV6,
		m.AddressMembership,
...
// xpfTcConntrackVariables contains all global variables after they have been loaded into the kernel.
//
// It can be passed to loadXpfTcConntrackObjects or ebpf.CollectionSpec.LoadAndAssign.
type xpfTcConntrackVariables struct {
}

// xpfTcConntrackPrograms contains all programs after they have been loaded into the kernel.
//
// It can be passed to loadXpfTcConntrackObjects or ebpf.CollectionSpec.LoadAndAssign.
type xpfTcConntrackPrograms struct {
	TcConntrackProg *ebpf.Program `ebpf:"tc_conntrack_prog"`
}

func (p *xpfTcConntrackPrograms) Close() error {
	return _XpfTcConntrackClose(
		p.TcConntrackProg,
	)
}

func _XpfTcConntrackClose(closers ...io.Closer) error {
...
//
//go:embed xpftcconntrack_x86_bpfel.o
var _XpfTcConntrackBytes []byte
