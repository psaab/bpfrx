...
rate limit, `lastStatus.ForwardingArmed`, and (#7497) a cap of
`maxConsecutiveAutoRebinds` attempts per wedge. So the honest figure is
**seconds**, not one tick. An earlier revision implied the latter (#6871
round 9).
