...
- **Screen/IDS**: 12 checks (land, SYN flood, ping of death, teardrop,
  icmp-fragment, ip-sweep, syn-frag, SYN-FIN, no-flag, winnuke, FIN-no-ACK,
  rate-limiting), SYN cookie flood
