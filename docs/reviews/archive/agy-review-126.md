# agy Review Audit 126 - Core Connection Tracking, NAT, Policy & Feed Validation
...
- Output path: `/tmp/agy-review-126.md`
...
### AGY-126-01 - Go Memory Model Data Race on Connection Tracking GC Configuration Fields
...
### AGY-126-02 - Static NAT Rule Shadowing and Overwrite Bug in `StaticNatTable::from_snapshots`
...
### AGY-126-03 - Commit/Apply Split & Simulator Discrepancy on Signed Port Specifications
...
### AGY-126-04 - Tolerant-Load Validation Bypass for Undefined Feeds on Empty/Slash-Only Feed Servers
