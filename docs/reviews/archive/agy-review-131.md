# agy Review Audit 131 - Core Connection Tracking, NAT, Policy & Feed Validation

## 1. Base Commit Reviewed

- Repository: `/home/ps/git/gemini-xpf`
- Base commit: `f427b03e35948d38a63ea6588e8584bf4bfa9a8c`
- Pull status: `git pull --rebase` completed successfully, pulling updates into the branch.
- Output path: `/tmp/agy-review-131.md`
...
- Prior `/tmp/codex-review*.md` / `/tmp/agy-review*.md` files cross-referenced:
  ...
  - `/tmp/codex-review-125.md`
  - `/tmp/codex-review-127.md`
  - `/tmp/codex-review-128.md`
...
### AGY-131-01 - Go Memory Model Data Race on Connection Tracking GC Configuration Fields
...
### AGY-131-02 - Static NAT Rule Shadowing and Overwrite Bug in `StaticNatTable::from_snapshots`
...
### AGY-131-03 - Commit/Apply Split & Simulator Discrepancy on Signed Port Specifications
...
### AGY-131-04 - Tolerant-Load Validation Bypass for Undefined Feeds on Empty/Slash-Only Feed Servers
