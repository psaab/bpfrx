# agy Review Audit 003 - Core Connection Tracking, NAT, Policy & Feed Validation
...
### AGY-003-01 - Go Memory Model Data Race on Connection Tracking GC Configuration Fields
...
### AGY-003-02 - Static NAT Rule Shadowing and Overwrite Bug in `StaticNatTable::from_snapshots`
...
### AGY-003-03 - Commit/Apply Split & Simulator Discrepancy on Signed Port Specifications
...
### AGY-003-04 - Tolerant-Load Validation Bypass for Undefined Feeds on Empty/Slash-Only Feed Servers
