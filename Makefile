...
.PHONY: all generate build build-ctl proto install clean test test-connectivity test-failover test-active-active test-stress-failover test-ha-crash build-dpdk-worker build-dpdk clean-dpdk
