...
other runs' files. Existing published reports stay where they are.
...
markers remain readable; do not move or overwrite them, or create new aliases.
...
select the next unused number across the new and legacy report roots, update the
