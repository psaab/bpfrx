// Tests for afxdp/umem/mod.rs. Split from a single ~1765-line
// tests.rs into per-concern sibling submodules (#4667) to keep each
// file under the modularity-discipline LOC threshold. Pure test-code
...
//   mmap_area  tx_inbox  latency_buckets  snapshot_propagation
